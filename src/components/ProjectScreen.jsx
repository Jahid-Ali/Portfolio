...
const ProjectScreen = () => {
  const projectLinks = [
    ...
    },
    {
      ...
      src: taskManager2,
      title: "TODO-APP",
      desc: "Todo-App is a baisc todo webapp, Here you can add your daily tasks and also you can Update and Delete it. In this instead of using axios.delete and axios.put, I am using axios.post for delete and update...",
    ...
    },
    {
      ...
      demo: "https://todolist-001.netlify.app/",
